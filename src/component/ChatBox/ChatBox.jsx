...
function ChatBox() {
  ...
  return (
    <div
      className="w-1/3 border-2 border-[#242424] rounded-lg flex flex-col"
      style={{ borderColor: "#242424" }}
    >
      <h1 className="text-center py-2 text-xl my-2 border-b border-[#242424] text-white bg-[#242424]">
        Chat Room
      </h1>
      <div className="flex-1 p-4 text-[#242424]">
      ...
      <div className="flex p-1">
        <input
          type="text"
          className="self-end w-ful h-[42px] px-3 py-[16px] border border-[#D9D9D9] placeholder:font-montserrat placeholder:text-[#242424] text-[#2D2D2D]"
